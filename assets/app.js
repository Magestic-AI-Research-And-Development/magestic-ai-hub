...
const SWE_SERIES=[
 ...
 {n:"Open weight frontier",c:"#c96a2b",pts:[
   ...
   ["2026-07",82.5,"Ornith-1.0",0,18,"middle"],["2026-08",86,"Ornith-1.5",9,4,"start"]]}
];
...
const HLE_BARS=[
 ...
 ["GPT-6 Astra",54.7,true],["GPT-5.6 Sol",49.5,true],["Muse Spark 1.3",49.1,true],
 ["Claude Opus 4.8",48.7,true],["Gemini 3.7 Flash",47.9,true],["Gemini 3.1 Pro",47,true],
 ["Kimi K3",46.9,true],["Grok 4.6",44.1,true],["GLM-5.2 (open)",41.1,false],
 ["DeepSeek V4 Pro (open)",41,false]
];
const ARC2_BARS=[
 ["GPT-6 Astra",95,true],["GPT-5.6 Sol",92.5,true],["Claude Opus 5",90.4,true],
 ["Claude Fable 5.1",90,true],["Claude Fable 5",89.2,true],["GPT-5.5",85,true],
...
const COST_BARS=[
 ...
 ["GPT-5.6 Terra",12,true],["Claude Sonnet 5",10,true],["Gemini 3.5 Flash",9,true],
 ["Grok 4.6",6,true],["Grok 4.5",6,true],["Claude Haiku 4.5",5,true],["Kimi K2.7 Code (open)",4,false],
